...
const CATALOG = [
  ...
  { id: 'adidas-zne-hoodie',  name: 'Adidas Z.N.E. Zip Hoodie',     nameAr: 'هودي أديداس زد إن إي', cat: 'Men', color: 'Grey',  desc: 'A premium full-zip hoodie in heathered grey with a modern fit — built for travel days and gym sessions alike.', material: 'Fleece blend', sizes: 'S, M, L, XL, XXL', img: 'assets/img/products/adidas-zne-hoodie.webp', now: 2600, old: 3400, rating: 5, badge: 'Hot' },
  { id: 'nike-air-fleece-hoodie', name: 'Nike Air Fleece Hoodie', nameAr: 'هودي نايك اير فليس', cat: 'Men', color: 'Black', desc: 'A colorblocked black-and-white fleece hoodie with the "Nike Air" graphic — heavyweight enough for a proper Cairo winter evening.', material: 'Cotton fleece blend', sizes: 'S, M, L, XL, XXL', img: 'assets/img/products/nike-air-fleece-hoodie.webp', now: 2100, old: 2800, rating: 5, badge: 'New' },
  { id: 'nike-club-hoodie',   name: 'Nike Club Fleece Hoodie',      nameAr: 'هودي نايك كلوب فليس', cat: 'Men', color: 'Grey',  desc: 'The everyday Nike hoodie in heather grey with the classic Futura logo — soft fleece that layers well under a jacket.', material: 'Cotton fleece', sizes: 'S, M, L, XL, XXL', img: 'assets/img/products/nike-club-grey-hoodie.webp', now: 1750, old: 2300, rating: 4, badge: '-24%' },
  { id: 'puma-black-hoodie',  name: 'Puma Essentials Hoodie',       nameAr: 'هودي بوما إسنشيالز', cat: 'Men', color: 'Black', desc: 'A no-fuss black pullover hoodie with the Puma cat logo — the wardrobe staple that works for the gym or a lazy Friday.', material: 'Cotton-poly fleece', sizes: 'S, M, L, XL, XXL', img: 'assets/img/products/puma-black-hoodie.webp', now: 1450, old: 1900, rating: 4, badge: '-24%' },
  { id: 'puma-women-hoodie',  name: 'Puma Zip-Up Hoodie',           nameAr: 'هودي بوما نسائي بسحاب', cat: 'Women', color: 'Black', desc: 'A cropped-fit zip-up hoodie in textured black fleece — easy to throw on over a tank after a workout or for a casual day out.', material: 'Textured fleece', sizes: 'XS, S, M, L', img: 'assets/img/products/puma-women-zip-hoodie.webp', now: 1650, old: 2150, rating: 5, badge: 'New' },
  { id: 'puma-logo-tee',      name: 'Puma Essentials Logo Tee',     nameAr: 'تي شيرت بوما إسنشيالز', cat: 'Men', color: 'Black', desc: 'A classic crewneck cotton tee with the bold Puma wordmark — an easy everyday layer that holds its shape wash after wash.', material: '100% Cotton', sizes: 'S, M, L, XL, XXL', img: 'assets/img/products/puma-logo-tee.webp', now: 620, old: 850, rating: 5, badge: '-27%' },

  /* Kids */
  { id: 'kids-nike-fleece-set', name: 'Kids Nike Fleece Set',       nameAr: 'طقم نايك فليس أطفال', cat: 'Kids', color: 'Black', desc: 'A matching hoodie-and-jogger fleece set with the Nike logo — warm, durable, and easy to mix into any school-run rotation.', material: 'Cotton fleece', sizes: '2–3Y, 4–5Y, 6–7Y, 8–9Y', img: 'assets/img/products/kids-nike-fleece-set.webp', now: 1350, old: 1750, rating: 5, badge: 'New' },
  { id: 'kids-puma-hoodie-set', name: 'Kids Puma Hoodie Set',       nameAr: 'طقم بوما هودي أطفال', cat: 'Kids', color: 'Green',  desc: 'A colorblocked zip-up hoodie and jogger set with the Puma cat logo — built for a full day of play without slowing down.', material: 'Cotton fleece', sizes: '2–3Y, 4–5Y, 6–7Y, 8–9Y', img: 'assets/img/products/kids-puma-zip-hoodie.webp', now: 1250, old: 1650, rating: 5, badge: 'Hot' },
  ...
  { id: 'leather-belt-buckle', name: 'Leather Belt, Statement Buckle', nameAr: 'حزام جلد بمشبك مميز', cat: 'Men', color: 'Tan', desc: 'A reversible tan leather belt with a polished statement buckle — a sharp finishing touch for tailored trousers or dark denim.', material: 'Genuine leather', sizes: '90, 100, 110, 120 (cm)', img: 'assets/img/products/leather-belt-buckle.webp', now: 850, old: 1150, rating: 4, badge: 'New' },
  { id: 'mens-leather-belts', name: 'Classic Leather Belt',          nameAr: 'حزام جلد كلاسيك', cat: 'Men', color: 'Brown', desc: 'A timeless leather belt with a brushed metal buckle, available in every shade to match your everyday rotation.', material: 'Genuine leather', sizes: '90, 100, 110, 120 (cm)', img: 'assets/img/products/mens-leather-belts.webp', now: 550, old: 750, rating: 4, badge: '-27%' },
  { id: 'camel-fedora',       name: 'Camel Wool Fedora',             nameAr: 'قبعة فيدورا كاميل', cat: 'Accessories', color: 'Camel', desc: 'A wide-brim wool felt fedora with a leather trim band — an easy way to dress up a simple outfit or shade Cairo\'s sun.', material: 'Wool felt, leather band', sizes: 'One Size (adjustable)', img: 'assets/img/products/camel-fedora-hat.webp', now: 950, old: 1300, rating: 5, badge: 'New' },
  { id: 'black-snapback',     name: 'Black Trucker Snapback',        nameAr: 'كاب تراكر أسود', cat: 'Accessories', color: 'Black', desc: 'A classic mesh-back trucker cap with an adjustable snapback closure — built for sunny afternoons and easy to keep in the car.', material: 'Cotton twill, mesh back', sizes: 'One Size (adjustable)', img: 'assets/img/products/black-trucker-cap.webp', now: 350, old: 480, rating: 4, badge: 'New' },
  { id: 'white-snapback',     name: 'White Trucker Snapback',        nameAr: 'كاب تراكر أبيض', cat: 'Accessories', color: 'White', desc: 'A crisp white mesh-back cap that keeps the sun off without ever feeling heavy — a warm-weather staple.', material: 'Cotton twill, mesh back', sizes: 'One Size (adjustable)', img: 'assets/img/products/white-trucker-cap.webp', now: 350, old: 480, rating: 4, badge: 'New' },
  { id: 'tortoise-sunglasses', name: 'Tortoise Square Sunglasses',   nameAr: 'نظارة شمس مربعة سلحفاة', cat: 'Accessories', color: 'Brown', desc: 'Bold square sunglasses in classic tortoiseshell acetate with full UV protection — a statement pair for Egypt\'s sunny days.', material: 'Acetate frame, UV400 lenses', sizes: 'One Size', img: 'assets/img/products/tortoise-sunglasses.webp', now: 620, old: 850, rating: 5, badge: 'New' },
  { id: 'square-metal-sunglasses', name: 'Square Metal-Frame Sunglasses', nameAr: 'نظارة شمس إطار معدني', cat: 'Accessories', color: 'Black', desc: 'Sharp square sunglasses in a slim gunmetal frame with dark tinted lenses — a clean, modern pair for everyday wear.', material: 'Metal frame, UV400 lenses', sizes: 'One Size', img: 'assets/img/products/square-metal-sunglasses.webp', now: 580, old: 780, rating: 4, badge: 'New' },
  { id: 'diamond-rimless-sunglasses', name: 'Diamond Rimless Sunglasses', nameAr: 'نظارة شمس بدون إطار', cat: 'Accessories', color: 'Gold', desc: 'Rimless diamond-cut lenses on a delicate gold frame — a directional pair that dresses up any casual outfit.', material: 'Metal frame, gradient lenses', sizes: 'One Size', img: 'assets/img/products/diamond-rimless-sunglasses.webp', now: 690, old: 920, rating: 4, badge: 'Hot' },
  { id: 'grey-wool-scarf',    name: 'Grey Wool Scarf',               nameAr: 'شال صوف رمادي', cat: 'Accessories', color: 'Grey', desc: 'A soft, fringed wool scarf in heather grey — light enough to wear draped, warm enough for Cairo\'s brief winter chill.', material: '100% Wool', sizes: 'One Size', img: 'assets/img/products/grey-wool-scarf.webp', now: 580, old: 780, rating: 5, badge: 'New' },
  { id: 'red-wool-scarf',     name: 'Red Wool Scarf',                nameAr: 'شال صوف أحمر', cat: 'Accessories', color: 'Red', desc: 'A bold red wool scarf with a soft fringed edge — an easy way to add color to a plain coat or jacket.', material: '100% Wool', sizes: 'One Size', img: 'assets/img/products/red-wool-scarf.webp', now: 580, old: 780, rating: 5, badge: 'Hot' },
